<header class="page-header">
    <h2>ชื่อ - นามสกุลที่ต้องการวิเคราะห์</h2>
    ...
    <div class="right-wrapper pull-right">
        <ol class="breadcrumbs">
            ...
            <li><span>วิเคราะห์/สังเคราะห์ ชื่อ - นามสกุล</span></li>
            <li><span>ชื่อ - นามสกุล</span></li>
        </ol>
    ...
    <div class="col-xs-12">
        <section class="panel">
            <header class="panel-heading">
                ...
                <h2 class="panel-title">ชื่อ - นามสกุลที่ต้องการวิเคราะห์</h2>
                <p class="panel-subtitle">
                    กรอกชื่อ - นามสกุลที่ต้องการวิเคราะห์
                </p>
            </header>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input id="fc_inputmask_1" type="text" name="namep" placeholder="ชื่อ - นามสกุล" class="form-control" value="<?=$_GET['namep']?>">
